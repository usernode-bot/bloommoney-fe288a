...
async function start() {
  ...
  const historyTokenDefs = [
    ...
    { symbol: 'SOL',   fn: (i) => (100    * (1 + Math.sin(i * 0.41 + 2) * 0.022)).toFixed(6) },
    { symbol: 'DOGE',  fn: (i) => (0.125  * (1 + Math.cos(i * 0.48 + 1) * 0.025)).toFixed(6) },
    { symbol: 'ADA',   fn: (i) => (0.40   * (1 + Math.sin(i * 0.36 + 3) * 0.020)).toFixed(6) },
